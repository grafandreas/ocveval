...
import org.grafandreas.opencv.eval.ide.contentassist.antlr.OCVEvalParser;
import org.grafandreas.opencv.eval.ide.contentassist.antlr.PartialOCVEvalContentAssistParser;
import org.grafandreas.opencv.eval.ide.contentassist.antlr.internal.InternalOCVEvalLexer;
import org.grafandreas.opencv.eval.ui.contentassist.OCVEvalProposalProvider;
import org.grafandreas.opencv.eval.ui.editor.OCVEvalEditor;
import org.grafandreas.opencv.eval.ui.labeling.OCVEvalDescriptionLabelProvider;
import org.grafandreas.opencv.eval.ui.labeling.OCVEvalLabelProvider;
import org.grafandreas.opencv.eval.ui.outline.OCVEvalOutlineTreeProvider;
import org.grafandreas.opencv.eval.ui.quickfix.OCVEvalQuickfixProvider;
import org.grafandreas.opencv.eval.validation.OCVEvalValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link OCVEvalUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractOCVEvalUiModule extends DefaultXbaseUiModule {

	public AbstractOCVEvalUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.grafandreas.opencv.eval.parser.antlr.internal.InternalOCVEvalLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return OCVEvalParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalOCVEvalLexer.class).toProvider(LexerProvider.create(InternalOCVEvalLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return OCVEvalValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return OCVEvalLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(OCVEvalDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return OCVEvalOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return OCVEvalQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return OCVEvalProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialOCVEvalContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("OCVEval Compare");
	}
