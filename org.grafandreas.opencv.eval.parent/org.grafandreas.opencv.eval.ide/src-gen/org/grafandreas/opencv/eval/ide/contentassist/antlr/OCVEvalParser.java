 ...
 */
package org.grafandreas.opencv.eval.ide.contentassist.antlr;
...
import org.grafandreas.opencv.eval.ide.contentassist.antlr.internal.InternalOCVEvalParser;
import org.grafandreas.opencv.eval.services.OCVEvalGrammarAccess;

public class OCVEvalParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(OCVEvalGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OCVEvalGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getXBlockExpressionWithoutBracesAccess().getGroup(), "rule__XBlockExpressionWithoutBraces__Group__0");
			builder.put(grammarAccess.getXBlockExpressionWithoutBracesAccess().getGroup_1(), "rule__XBlockExpressionWithoutBraces__Group_1__0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getGroup(), "rule__XMethodDeclaration__Group__0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getGroup_1(), "rule__XMethodDeclaration__Group_1__0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getGroup_1_2(), "rule__XMethodDeclaration__Group_1_2__0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getGroup_5(), "rule__XMethodDeclaration__Group_5__0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getGroup_5_1(), "rule__XMethodDeclaration__Group_5_1__0");
			...
			builder.put(grammarAccess.getModelAccess().getMethodsAssignment_1(), "rule__Model__MethodsAssignment_1");
			builder.put(grammarAccess.getModelAccess().getBodyAssignment_2(), "rule__Model__BodyAssignment_2");
			builder.put(grammarAccess.getXBlockExpressionWithoutBracesAccess().getExpressionsAssignment_1_0(), "rule__XBlockExpressionWithoutBraces__ExpressionsAssignment_1_0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getTypeParametersAssignment_1_1(), "rule__XMethodDeclaration__TypeParametersAssignment_1_1");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getTypeParametersAssignment_1_2_1(), "rule__XMethodDeclaration__TypeParametersAssignment_1_2_1");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getTypeAssignment_2(), "rule__XMethodDeclaration__TypeAssignment_2");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getNameAssignment_3(), "rule__XMethodDeclaration__NameAssignment_3");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getParametersAssignment_5_0(), "rule__XMethodDeclaration__ParametersAssignment_5_0");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getParametersAssignment_5_1_1(), "rule__XMethodDeclaration__ParametersAssignment_5_1_1");
			builder.put(grammarAccess.getXMethodDeclarationAccess().getBodyAssignment_7(), "rule__XMethodDeclaration__BodyAssignment_7");
	...
	@Override
	protected InternalOCVEvalParser createParser() {
		InternalOCVEvalParser result = new InternalOCVEvalParser(null);
