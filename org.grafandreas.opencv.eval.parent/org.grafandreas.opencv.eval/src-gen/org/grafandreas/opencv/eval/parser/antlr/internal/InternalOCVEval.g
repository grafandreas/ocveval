...
entryRuleXBlockExpressionWithoutBraces returns [EObject current=null]:
	...
	{ $current=$iv_ruleXBlockExpressionWithoutBraces.current; }
	EOF;

// Rule XBlockExpressionWithoutBraces
ruleXBlockExpressionWithoutBraces returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXMethodDeclaration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXMethodDeclarationRule()); }
	iv_ruleXMethodDeclaration=ruleXMethodDeclaration
	{ $current=$iv_ruleXMethodDeclaration.current; }
	EOF;

// Rule XMethodDeclaration
ruleXMethodDeclaration returns [EObject current=null]
@init {
	enterRule();
}
@after {
