...
import org.grafandreas.opencv.eval.oCVEval.OCVEvalFactory;
 ...
 * @generated
 */
public class OCVEvalPackageImpl extends EPackageImpl implements OCVEvalPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.grafandreas.opencv.eval.oCVEval.OCVEvalPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private OCVEvalPackageImpl()
  {
    super(eNS_URI, OCVEvalFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link OCVEvalPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static OCVEvalPackage init()
  {
    if (isInited) return (OCVEvalPackage)EPackage.Registry.INSTANCE.getEPackage(OCVEvalPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredOCVEvalPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    OCVEvalPackageImpl theOCVEvalPackage = registeredOCVEvalPackage instanceof OCVEvalPackageImpl ? (OCVEvalPackageImpl)registeredOCVEvalPackage : new OCVEvalPackageImpl();
    ...
    theOCVEvalPackage.createPackageContents();

    // Initialize created meta-data
    theOCVEvalPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theOCVEvalPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(OCVEvalPackage.eNS_URI, theOCVEvalPackage);
    return theOCVEvalPackage;
  }
   ...
   */
  @Override
  public OCVEvalFactory getOCVEvalFactory()
  {
    return (OCVEvalFactory)getEFactoryInstance();
  }
