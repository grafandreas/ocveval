...
public class OCVEvalSyntacticSequencer extends AbstractSyntacticSequencer {

	protected OCVEvalGrammarAccess grammarAccess;
	protected AbstractElementAlias match_XBlockExpressionWithoutBraces_SemicolonKeyword_1_1_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (OCVEvalGrammarAccess) access;
		match_XBlockExpressionWithoutBraces_SemicolonKeyword_1_1_q = new TokenAlias(false, true, grammarAccess.getXBlockExpressionWithoutBracesAccess().getSemicolonKeyword_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_XBlockExpressionWithoutBraces_SemicolonKeyword_1_1_q.equals(syntax))
				emit_XBlockExpressionWithoutBraces_SemicolonKeyword_1_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_XBlockExpressionWithoutBraces_SemicolonKeyword_1_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
