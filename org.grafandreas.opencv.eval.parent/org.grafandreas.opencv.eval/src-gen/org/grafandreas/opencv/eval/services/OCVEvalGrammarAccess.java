 ...
 */
package org.grafandreas.opencv.eval.services;
...
@Singleton
public class OCVEvalGrammarAccess extends AbstractGrammarElementFinder {
	
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.grafandreas.opencv.eval.OCVEval.Model");
		...
		private final RuleCall cMethodsXMethodDeclarationParserRuleCall_1_0 = (RuleCall)cMethodsAssignment_1.eContents().get(0);
		private final Assignment cBodyAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cBodyXBlockExpressionWithoutBracesParserRuleCall_2_0 = (RuleCall)cBodyAssignment_2.eContents().get(0);
		...
		//importSection=XImportSection? methods+=XMethodDeclaration* body=XBlockExpressionWithoutBraces
		...
		//XMethodDeclaration
		public RuleCall getMethodsXMethodDeclarationParserRuleCall_1_0() { return cMethodsXMethodDeclarationParserRuleCall_1_0; }
		
		//body=XBlockExpressionWithoutBraces
		public Assignment getBodyAssignment_2() { return cBodyAssignment_2; }
		
		//XBlockExpressionWithoutBraces
		public RuleCall getBodyXBlockExpressionWithoutBracesParserRuleCall_2_0() { return cBodyXBlockExpressionWithoutBracesParserRuleCall_2_0; }
	}
	public class XBlockExpressionWithoutBracesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.grafandreas.opencv.eval.OCVEval.XBlockExpressionWithoutBraces");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//XBlockExpressionWithoutBraces xbase::XBlockExpression:
	...
	public class XMethodDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.grafandreas.opencv.eval.OCVEval.XMethodDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//XMethodDeclaration:
		//	"def" ('<' typeParameters+=JvmTypeParameter (',' typeParameters+=JvmTypeParameter)* '>')? type=JvmTypeReference?
		//	name=ID "(" (parameters+=FullJvmFormalParameter ("," parameters+=FullJvmFormalParameter)*)? ")"
		//	body=XBlockExpression;
		@Override public ParserRule getRule() { return rule; }
		
		//"def" ('<' typeParameters+=JvmTypeParameter (',' typeParameters+=JvmTypeParameter)* '>')? type=JvmTypeReference? name=ID
	...
	private final XBlockExpressionWithoutBracesElements pXBlockExpressionWithoutBraces;
	private final XMethodDeclarationElements pXMethodDeclaration;
	...
	@Inject
	public OCVEvalGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pXBlockExpressionWithoutBraces = new XBlockExpressionWithoutBracesElements();
		this.pXMethodDeclaration = new XMethodDeclarationElements();
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.grafandreas.opencv.eval.OCVEval".equals(grammar.getName())) {
				return grammar;
			}
	...
	//XBlockExpressionWithoutBraces xbase::XBlockExpression:
	//	{xbase::XBlockExpression} (expressions+=XExpressionOrVarDeclaration ';'?)*;
	public XBlockExpressionWithoutBracesElements getXBlockExpressionWithoutBracesAccess() {
		return pXBlockExpressionWithoutBraces;
	}
	
	public ParserRule getXBlockExpressionWithoutBracesRule() {
		return getXBlockExpressionWithoutBracesAccess().getRule();
	}
	...
	//	name=ID "(" (parameters+=FullJvmFormalParameter ("," parameters+=FullJvmFormalParameter)*)? ")"
	//	body=XBlockExpression;
	public XMethodDeclarationElements getXMethodDeclarationAccess() {
		return pXMethodDeclaration;
	}
	
	public ParserRule getXMethodDeclarationRule() {
		return getXMethodDeclarationAccess().getRule();
	}
