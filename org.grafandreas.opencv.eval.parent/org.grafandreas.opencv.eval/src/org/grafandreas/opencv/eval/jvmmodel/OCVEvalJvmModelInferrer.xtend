 ...
 */
package org.grafandreas.opencv.eval.jvmmodel
 ...
 */
class OCVEvalJvmModelInferrer extends AbstractModelInferrer {
...
acceptor.accept(
   			...
   			model.toClass("org.grafandreas.opencv.eval.Query" + postfix)
   		) [
